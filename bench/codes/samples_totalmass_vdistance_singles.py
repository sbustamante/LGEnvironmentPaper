#samples_totalmass_vdistance_single.py
#
#This code calculate histogram of the total mass of the pair samples vs the distance to void 
#regions of each respective system. Each histogram is calculated for different mass ranges in 
