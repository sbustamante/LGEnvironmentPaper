#samples_tangentialvelocity_FA.py
#
#This code calculate 2D histogram of the tangental velocity distrbution of the pair samples vs the 
...
for fold in folds:
    ...
    v_rad_IP, P_IP = Velocities( M1, x1, y1, z1, vx1, vy1, vz1, M2, x2, y2, z2, vx2, vy2, vz2)
    ...
    x2 = halos[ 1, I2 ];  y2 = halos[ 2, I2 ]; z2 = halos[ 3, I2 ]
    vx2 = halos[ 4, I2 ]; vy2 = halos[ 5, I2 ]; vz2 = halos[ 6, I2 ]
    v_rad_RIP, P_RIP = Velocities( M1, x1, y1, z1, vx1, vy1, vz1, M2, x2, y2, z2, vx2, vy2, vz2)
...
axHist2D.set_ylabel( "Tangential Velocity $v_{tan}$ [km s$^{-1}$]", fontsize=15 )
