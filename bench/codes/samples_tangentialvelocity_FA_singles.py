#samples_tangentialvelocity_FA_single.py
#
#This code calculate histogram of the tangential velocity of the pair samples vs the fractional 
...
for fold in folds:
	...
	plt.text( 0.75, 4.5\
	,"$%1.2f\leq v_{tan}<%1.2f$"%( Mmin, Mmax ),\
