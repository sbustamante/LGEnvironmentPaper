...
Once defined the general characteristics of preferred environment for each 
...
and tangential velocities, angular momentum and total energy and finally 
the reduced spin parameter. After, we look for effects on the history of 
each system, so we shall analyse all the parameters of the MAH (Mass 
Assembly History) of each pair, like the last major merger time, the 
formation time and the assembly time. Finally, we quantify different 
possible alignments of pairs regarding characteristic directions of the 
environment, like the eigenvectors of each web scheme, of the principal 
