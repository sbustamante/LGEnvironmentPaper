...
the CLUES project was done by \SRKED{[reference here]}, a summary of the 
...
performed using the Tree-PM MPI N-body code Gadget2 \SRKED{[reference 
here]}. The cosmological parameters are consistent with a WMAP5 and WMAP7 
cosmologies with $\Omega_{\rm m}=0.28$, $\Omega_{\Lambda}=0.72$, $h=0.73$, 
$n=0.73$ and $\sigma_{8}=0.817$ \SRKED{[reference to Komatsu]} for the 
