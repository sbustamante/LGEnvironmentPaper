...
certain range of the fractional isotropy and each one of the above defined
...
between \texttt{RIP} systems and \texttt{IP} systems, even for both web 
schemes. In spite of all the halos of the simulation are distributed mainly
in very anisotropic regions like voids and sheet-like regions, 
...
because of the mass cut-off or the relative distance range chosen as the 
extra criteria for selecting the \texttt{RIP} sample, thus indicating a 
first possible environmental correlation.



The above discussion reinforces the results obtained in the  previous 
subsection \ref{subsec:tensorial_schemes}, showing the complementary 
character of the fractional anisotropy. Returning back to the discussion 
about the quantification of the environment leaded by the fractional 
anisotropy, the only conclusion that can be done is 
...
\begin{center}
  ...
  anisotropy for each web scheme. T-web (right panel). V-web (left panel).
